        ...
        <div className="lg:col-span-3 space-y-4">
          <ComicCard variant="gradient" shadow="medium">
            ...
            {user ? (
              ...
              <div className="mb-4 p-6 text-center comic-border-2 rounded-xl bg-[#F8E4C6] comic-shadow-inner text-[#2c2c2c]">
                <p className={cn(body.className, "text-sm mb-3")}>
                  You need to be logged in to leave a roast or comment.
                </p>
                <button
                  type="button"
                  onClick={() => router.push("/login")}
                  className={cn(display.className, "comic-btn bg-yellow hover:bg-[#e8c98a] comic-shadow-3 comic-lift px-6 py-2 text-sm")}
                >
                  Sign In to Roast
                </button>
              </div>
